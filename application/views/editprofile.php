...
<html lang="en">
    ...
    <body>
        ...
        <!-- Main -->
        <div id="page" class="white-version color-bg-green">
            <?php /*?><header id="nav" class="dark-nav-colored-hero">
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse-md" id="navbar-collapse">
                            ...
                            <ul class="nav navbar-nav navbar-left">
                                ...
                                <li><a href="#login-register" class="smooth-scroll hide">Login / Register</a></li>
                            </ul>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li>
                                    <ul class="social logged-in_menu">
                                        <li><i class="fa fa-user"></i> &nbsp;Welcome John</li>
                                        <li><a class="" href="index.php/myaccount">My account</a></li>
                                    </ul>
                                </li>
                            </ul>
                ...
                <nav class="navbar navbar-fixed-top headernavbar">
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse-md" id="navbar-collapse">
                            ...
                            <!-- Navigation Links -->
                            <ul class="nav navbar-nav navbar-left">
                                <li><a href="http://www.codersprint.com/ci/index.php/licencemanager">Licence Manager</a></li>
            ...
            <?php /* ?><section id="myaccount" class="bg-color-dark opacity-90 text-white">
                <div class="container">
            ...
            <section id="profile-info" cclass="color-bg-green section-p-lg ordersection-container main-container clearfix">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
            ...
            <?php /* ?><section id="change-password" class="bg-color-dark opacity-90 text-white section-p-lg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
            ...
            <?php /* ?><section id="order-history" class="bg-darkgrey opacity-90 section-p-lg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
