$(document).ready(function () {
    ...
    $('.lmanegerBlock-seat li input[type="checkbox"]').change(function(){
      if($(this).is(":checked")) {
        $(this).parents('.lmanegerBlock-seat li').siblings().find('input[type="checkbox"]').removeAttr('checked');
          $('.lmanegerBlock-seat li').removeClass('active');
          $('.seat-item-lists').slideUp(500);
          $(this).attr('checked');
          $(this).parents('.lmanegerBlock-seat li').addClass('active');
          $(this).parents('.seat-item').children('.seat-item-lists').slideDown(500);
      } else {
          $(this).parents('.lmanegerBlock-seat li').removeClass('active');
          $(this).parents('.seat-item').children('.seat-item-lists').slideUp(500);
      }
  });


    var countItem = 0; 
    $('.countlicence-block .form-control').val(countItem);
    $('.countlicence-block .btn-mins').on("click", function(event) {
      event.preventDefault();
      if (countItem <= 0) {
        countItem = 0;
      } else {
    ...
    $('.countlicence-block .btn-plus').on("click", function(event) {
      event.preventDefault();
      countItem++;
      $('.countlicence-block .form-control').val(countItem);
    });
    ...
    $('.adduserClick').click(function(event) {
      event.preventDefault();
      $('.adduserlightbox-bg').fadeIn(700, function() {
        $('.userlightclose').click(function(event) {
          event.preventDefault()
          $('.adduserlightbox-bg').fadeOut(700, function() {
