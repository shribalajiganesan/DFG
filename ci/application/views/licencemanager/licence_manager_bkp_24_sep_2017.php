  ...
  <div class="container">
    ...
    <form action="">
      <div class="form-group">
        <input type="text" name="first_name" class="form-control form-control-white" placeholder="Search...">
      </div>
...
<div class="adduserlightbox-bg" >
  <div class="adduserlightbox-block" style="background-color: #eaeaea !important;">
    ...
    <form action="">
      <div class="lmanegerBlock-creation" >
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <input type="text" name="last_name" id="first_name" class="form-control form-control-white" placeholder="Last Name" >
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <input type="text" name="email_id" id="email_id" class="form-control form-control-white" placeholder="Email Id" >
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <input type="text" name="phone" id="phone" class="form-control form-control-white" placeholder="Phone" >
              </div>
            </div>
          </div>
          <div class="form-group">
