                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse-md" id="navbar-collapse">
                            ...
                            <ul class="nav navbar-nav navbar-left">
                                ...
                                <li class="active"><a href="http://www.codersprint.com/ci/index.php/orderhistory">Order History</a></li>
                            </ul>
                                    ...
                                    <div class="table-responsive">
                                      <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1.</td>
                                                <td>q2ew-aseg-v56nt</td>
                                                <td>17.07.2017. 430PM</td>
                                                <td>Delivered</td>
                                                <td>02</td>
                                                <td>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rerum facilis beatae nemo sapiente. Tempore tempora, saepe, sint, impedit ea reprehenderit voluptate eligendi totam accusantium ab atque porro repellendus. Ea, magni.</td>
                                                <td>20.00$</td>
                                            </tr>
                                            <tr>
                                                <td>1.</td>
