    ...
    <nav class="navbar navbar-fixed-top headernavbar">
      <div class="container">
        <div class="navbar-header"> 
          ...
          <!-- Logo --> 
          <a href="#page" class="navbar-brand logo-wg smooth-scroll"><span></span></a> </div>
        <!-- /End Navbar hero -->
        <div class="collapse navbar-collapse-md" id="navbar-collapse"> 
          <!-- Navigation Links -->
          <ul class="nav navbar-nav navbar-left">
            <li><a href="<?php echo base_url('licencemanager'); ?>">Licence Manager</a></li>
          ...
          <ul class="nav navbar-nav navbar-right headeruser">
            <li>
              <ul class="social logged-in_menu">
                <li class="dropdown"> <a class="" href="index.php/myaccount"><span class="userImage"><img class="img-circle" src="assets/images/user.png" alt=""></span> Welcome <span class="username"><?= $user['name']; ?></span></a> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="caret"></span></a>
                  <ul class="dropdown-menu">
                    <li><a href="<?= base_url('index.php/editprofile') ?>"><i class="fa fa-pencil" aria-hidden="true"></i> Profile Edit</a></li>
